...
int main(int argc, char** argv){
    ...
    try
    {
        ...
        K.setZero();
        K.topLeftCorner(3,3) << 100 * Eigen::MatrixXd::Identity(3,3);   // x y z stiffness
        D.setZero();
        D.topLeftCorner(3,3) << 50 * Eigen::MatrixXd::Identity(3,3);   // x y z damping
        ...
        //unsigned int counter = 0;
        std::array<double,16> goal_pose_array;
